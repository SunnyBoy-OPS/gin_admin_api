    ...
    "paths": {
        ...
        "/api/connect-test-host": {
            "post": {
                ...
                "tags": [
                    "测试连接主机--（host/ip、端口、账号、密码）"
                ],
                "summary": "测试连接主机",
                "parameters": [
                    {
                        "description": "通过 SSH 测试连接主机",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ConnectTestHost"
                        }
                    }
                ],
                "responses": {
